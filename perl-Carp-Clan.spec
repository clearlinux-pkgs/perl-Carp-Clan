...
cp LICENSE %{buildroot}/usr/share/package-licenses/perl-Carp-Clan/LICENSE
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/Carp/Clan.pm
...
/usr/share/package-licenses/perl-Carp-Clan/LICENSE
