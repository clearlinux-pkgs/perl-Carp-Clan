...
Requires: perl-Carp-Clan-perl = %{version}-%{release}
BuildRequires : buildreq-cpan

%description
This archive contains the distribution Carp-Clan,
version 6.08:
...
%package perl
Summary: perl components for the perl-Carp-Clan package.
Group: Default
Requires: perl-Carp-Clan = %{version}-%{release}

%description perl
perl components for the perl-Carp-Clan package.


%prep
%setup -q -n Carp-Clan-6.08
cd %{_builddir}/Carp-Clan-6.08
...
cp %{_builddir}/Carp-Clan-6.08/LICENSE %{buildroot}/usr/share/package-licenses/perl-Carp-Clan/95f4fb2d896db00273027432a3fecb618708361a
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Carp-Clan/95f4fb2d896db00273027432a3fecb618708361a

%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/Carp/Clan.pm
